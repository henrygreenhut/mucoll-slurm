...
INPUT = ROOT / "phi_anisotropy_out" / "photon_phi_upper_cut_counts.json"
OUTPUT = ROOT / "phi_anisotropy_out" / "photon_phi_upper_energy_cuts"
...
def main():
    ...
    axis.set_title(r"Unrotated BIB photon $\phi$ below energy thresholds", fontsize=20, pad=18)
